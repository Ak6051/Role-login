...
const Sidebar = () => {
  ...
  return (
    ...
    >
      ...
      <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', p: 2 }}>
        <img src={settings.logoUrl || "mascot.png"} alt="Company Logo" style={{ width: '180px', height: '80px', marginBottom: '8px' }} />
        <Typography variant="h6">{settings.companyName || "Company Name"}</Typography>
      </Box>
